    ...
    stages {
        ...
        stage('Ansible'){
            steps {
                ...
                sh 'sshpass -p ChangeMe ssh -o -tt StrictHostKeyChecking=no sowmya@10.10.10.108'
                sh 'sshpass -p ChangeMe ssh -o -tt StrictHostKeyChecking=no sowmya@10.10.10.171'
            }
        }
    }
}