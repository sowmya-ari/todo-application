    ...
    stages {
        ...
        stage('Ansible'){
            steps {
                ...
                sh 'ssh-keygen -R 10.10.10.108'
                sh 'ssh-copy-id -i ~/.ssh/id_rsa sowmya@10.10.10.108 && ssh -i ~/.ssh/id_rsa sowmya@10.10.10.108'
                sh 'ssh-copy-id -i ~/.ssh/id_rsa sowmya@10.10.10.171 && ssh -i ~/.ssh/id_rsa sowmya@10.10.10.171'
            }
        }
    }
}