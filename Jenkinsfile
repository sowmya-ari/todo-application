    ...
    stages {
        ...
        stage('Ansible'){
            steps {
                ...
                sh 'sshpass -p ChangeMe ssh -tt -o StrictHostKeyChecking=no -p 22 root@10.10.10.108 sleep 5 && sshpass -p ChangeMe ssh -tt -o StrictHostKeyChecking=no root@10.10.10.171 sleep 5'
