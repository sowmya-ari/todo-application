    ...
    stages {
        ...
        stage('Ansible'){
            steps {
                ...
                sh 'sshpass -p ChangeMe ssh -c -tt -o StrictHostKeyChecking=no sowmya@10.10.10.108 sleep 5 && sshpass -p ChangeMe ssh -tt -o StrictHostKeyChecking=no sowmya@10.10.10.171 sleep 5'
